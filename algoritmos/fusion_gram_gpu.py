# -*- coding: utf-8 -*-
"""fusion_gram_gpu.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nosIP-whT2ggc2YPFPpHqD6WyKi7dFeh
"""
...
def calcular_escalar(fusioned_image):
    ...
    for n in range(N):
        ...
        for m in range(n):
            ...
            matriz_temp_gpu[:,:,n] = gpuarray.to_gpu(matriz_temp[:,:,n].astype(np.float32)) - resultado * gpuarray.to_gpu(matriz_temp[:,:,m].astype(np.float32))
...
def fusion_bandas(matriz_temp):
    ...
    for n in range(limit):
        ...
        for m in range(n):
            bandas_temp_gpu[:,:,n] = gpuarray.to_gpu(bandas_temp[:,:,n].astype(np.float32)) + resultados[k] * gpuarray.to_gpu(matriz_temp[:,:,m].astype(np.float32))
